        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Owners_Countries_NationalityId",
                        column: x => x.NationalityId,
                        principalTable: "Countries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoodsWeight = table.Column<double>(type: "float", nullable: true),
                    GoodsDimensions = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TruckTypeId = table.Column<byte>(type: "tinyint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TruckTypeId = table.Column<byte>(type: "tinyint", nullable: false),
                    TemperatureRequirement = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TripOwners", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TripPictures", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TripPictures_Attachments_PictureId",
                        column: x => x.PictureId,
                        principalTable: "Attachments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TripPictures_Trips_TripId",
                        column: x => x.TripId,
                        principalTable: "Trips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OwnerTrucks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OwnerTrucks_Owners_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Owners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OwnerTrucks_Trucks_TruckId",
                        column: x => x.TruckId,
                        principalTable: "Trucks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TruckPictures_Attachments_PictureId",
                        column: x => x.PictureId,
                        principalTable: "Attachments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TruckPictures_Trucks_TruckId",
                        column: x => x.TruckId,
                        principalTable: "Trucks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Drivers_PhotoId",
                table: "Drivers",
                column: "PhotoId");

            migrationBuilder.CreateIndex(
                name: "IX_Owners_NationalityId",
                table: "Owners",
                column: "NationalityId");

            migrationBuilder.CreateIndex(
                name: "IX_OwnerTrucks_OwnerId",
                table: "OwnerTrucks",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_OwnerTrucks_TruckId",
                table: "OwnerTrucks",
                column: "TruckId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TripOwners_TripId",
                table: "TripOwners",
                column: "TripId");

            migrationBuilder.CreateIndex(
                name: "IX_TripPictures_PictureId",
                table: "TripPictures",
                column: "PictureId");

            migrationBuilder.CreateIndex(
                name: "IX_TripPictures_TripId",
                table: "TripPictures",
                column: "TripId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TruckPictures_PictureId",
                table: "TruckPictures",
                column: "PictureId");

            migrationBuilder.CreateIndex(
                name: "IX_TruckPictures_TruckId",
                table: "TruckPictures",
                column: "TruckId");
